# Contributing to DiscountCalculator

We welcome you to [check the existing issues](https://github.com/DRMPN/DiscountCalculator/issues) for bugs or enhancements to work on.
If you have an idea for an extension to DiscountCalculator, please [file a new issue](https://github.com/DRMPN/DiscountCalculator/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/DRMPN/DiscountCalculator/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/DiscountCalculator.git
   ```
...
Finally, go to the web page of your fork of the DiscountCalculator repo, and click
...
If your contribution changes DiscountCalculator in any way:

- Update the [README](https://github.com/DRMPN/DiscountCalculator/tree/master/README.MD) if anything there has changed.
