...
about: Want us to add any features to DiscountCalculator?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with DiscountCalculator. Please take the time to
...
<!--
  Why do you want to see this feature in DiscountCalculator? What use cases does it support?
-->
